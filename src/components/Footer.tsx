...
export default function Footer(): React.JSX.Element {
  ...
  return (
    <footer
      ref={footerRef}
      className="fixed bottom-0 left-0 right-0 md:left-auto md:right-0 z-40 pointer-events-none flex items-center justify-center md:justify-end gap-6 pb-10 px-5 md:pr-12"
